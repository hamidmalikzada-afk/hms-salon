              ...
              <div className="app-shell">
                ...
                <aside className={`sidebar${isSidebarOpen ? " open" : ""}`}>
                  <div className="brand-panel">
                    ...
                    <p className="brand-copy">
                      Manage customers, bookings, billing, and the live service queue
                      from one workspace.
                    </p>
                  </div>
                  ...
                  <div className="sidebar-user">
                    ...
                    <p className="sidebar-user-role">{roleLabel(auth.user?.role)}</p>
                ...
                <main className="app-main">
                  ...
                  <Routes>
                    ...
                    <Route path="/customers" element={<Customers auth={auth} />} />
                    <Route path="/staff" element={<Staff auth={auth} />} />
                    <Route path="/expenses" element={<Expenses auth={auth} />} />
                    <Route
                      path="/commissions"
                    ...
                    />
                    <Route path="/invoices" element={<Invoices auth={auth} />} />
